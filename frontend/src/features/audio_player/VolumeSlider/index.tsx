...
export const VolumeSlider = () => {
  ...
  return (
    <div className="flex items-center gap-3 w-32 select-none h-5">
      {/* Кнопка динамика (Mute/Unmute) с фиксированным размером */}
      <button 
        onClick={handleMuteToggle}
        className="w-5 h-5 flex items-center justify-center flex-shrink-0 text-gray-400 hover:text-white transition outline-none"
        title="Громкость"
      >
        {volume === 0 ? (
