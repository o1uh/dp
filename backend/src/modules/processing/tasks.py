...
def process_audio(self, task_id: str, s3_key_original: str, file_id: str, model_config: dict = None):
    ...
    try:
        ...
        if is_mock_mode:
            ...
            # real
            # =================================================================
            logger.info(f"Downloading original track from S3 (key: {s3_key_original})...")
            ...
            if model_type == "cascade_guitar" and cached_stems:
                logger.info("Sequential cascade track separation (cached) activated.")
                ...
                logger.info("Running guitar-stem inference...")
                ...
                logger.info(f"Executing standard track separation (model: {model_type})...")
...
def render_session(self, task_id: str, track_configs: list, file_id: str, model_config: dict = None):
    ...
    try:
        ...
        if is_mock_mode:
            ...
            logger.info(f"Compiling ZIP archive at: {output_file}")
